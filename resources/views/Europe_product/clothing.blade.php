...
<head>
    ...
    <title>Clothing to Europe |  </title>
</head>
<body>
    <div class="title_container">
        <p>Home / Shop / Europe STORE / Clothing Accessories to Europe Store</p>
        <h1>Clothing Accessories Europe Store</h1>
    </div>
            ...
            <div class="main_prod_cobtainer">
                ...
                <div class="main_prod_card">
                    ...
                    <div  class="info_container">
                        <p>
                            <a href="{{ url('/europe_productdetails', $prod->id) }}" style="color: black;"> {{ $prod->title}} </a>
                        </p>
                        <h5>#{{ $prod->price}}</h5>
                        <button><a href="{{ url('/buy_europe', $prod->id) }}">Buy Now</a></button>
                    </div>
                </div>
                @endforeach
            </div>
