...
<body>
    ...
    <div class="title_container">
        <p>Home / Shop / Asian STORE / Clothing Accessories to Asian Store</p>
        <h1>Clothing Accessories Asian Store</h1>
    </div>
            ...
            <div class="main_prod_cobtainer">
                ...
                <div class="main_prod_card">
                    ...
                    <div  class="info_container">
                        <p>
                            <a href="{{ url('/asian_productdetails', $prod->id) }}" style="color: black;"> {{ $prod->title}} </a>
                        </p>
                        <h5>#{{ $prod->price}}</h5>
                        <button><a href="{{ url('/buy_asian', $prod->id) }}">Buy Now</a></button>
                    </div>
                </div>
                @endforeach
            </div>
