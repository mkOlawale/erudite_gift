...
<body>
    ...
    <div class="title_container">
        <p>Home / Shop / UK STORE / Adult Items to UK Store</p>
        <h1>Adult Items UK Store</h1>
    </div>
            ...
            <div class="main_prod_cobtainer">
                ...
                <div class="main_prod_card">
                    ...
                    <div  class="info_container">
                        <p>
                            <a href="{{ url('/uk_productdetails', $prod->id) }}" style="color: black;"> {{ $prod->title}} </a>

                        </p>
                        <h5>#{{ $prod->price}}</h5>
                        <button><a href="{{ url('/buy_uk', $product->id) }}">Buy Now</a></button>
                    </div>
                </div>
                @endforeach
            </div>
