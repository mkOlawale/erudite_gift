...
<html lang="en">
  <head>
    ...
    <title>EruditeGift Admin Canada</title>
    <!-- plugins:css -->
     ...
     @include('admin.nav')
        ...
        <div class="main-panel">
          ...
          <div class="div_center">
            <h1 class="txt-font">Add Canada Available Products</h1>

          <form action="{{ url('/addcanada_products') }}" method="POST" enctype="multipart/form-data">
            @csrf
