...
<html lang="en">
  <head>
    ...
    <title>EruditeGift Admin United Kingdom</title>
    <!-- plugins:css -->
     ...
     @include('admin.nav')
        ...
        <div class="main-panel">
          ...
          <div class="div_center">
            <h1 class="txt-font">Add UK Available Products</h1>

          <form action="{{ url('/adduk_products') }}" method="POST" enctype="multipart/form-data">
            @csrf
