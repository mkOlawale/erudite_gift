...
<html lang="en">
  <head>
    ...
    <title>EruditeGift Admin USA</title>
    <!-- plugins:css -->
     ...
     @include('admin.nav')
        ...
        <div class="main-panel">
          ...
          <div class="div_center">
            <h1 class="txt-font">Add Usa Available Products</h1>

          <form action="{{ url('/addusa_products') }}" method="POST" enctype="multipart/form-data">
            @csrf
