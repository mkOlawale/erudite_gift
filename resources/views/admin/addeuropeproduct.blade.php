...
<html lang="en">
  <head>
    ...
    <title>EruditeGift Admin Europe</title>
    <!-- plugins:css -->
     ...
     @include('admin.nav')
        ...
        <div class="main-panel">
          ...
          <div class="div_center">
            <h1 class="txt-font">Add European Available Products</h1>

          <form action="{{ url('/addeurope_products') }}" method="POST" enctype="multipart/form-data">
            @csrf
